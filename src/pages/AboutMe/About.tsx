      ...
      <div className={st.container}>
        <div className={st.container_gretting}>
          <div className={st.container_gretting_text}>
            ...
            <p>
              А мир IT буквально кричит из каждого "утюга", что здесь придется постоянно развиваться
              ...
              добавить деталь, не поломав при этом остальную конструкцию, и это безусловно
              затягивает, заставляя забывать о времени, и с удивлением обнаруживать, что за окном
              давно стемнело.
            </p>
          </div>
